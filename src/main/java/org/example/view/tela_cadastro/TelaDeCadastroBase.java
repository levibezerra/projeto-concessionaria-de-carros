...
public abstract class TelaDeCadastroBase extends JFrame {
    ...
    public TelaDeCadastroBase(EntityManager em) {
        this.em = em;
        setSize(1280, 780);
        setLayout(null);
        setResizable(false);
        ...
        adicionarComponentesDeCadastro();
        setVisible(true);
    }

    public abstract void adicionarOuvintes();

    public void adicionarComponentesDeCadastro() {
        ...
        textCpf.setBounds(70, 360, 500, 50);
        ...
        textEndereco.setBounds(70, 550, 500, 50);
        ...
        textEmail.setBounds(700, 360, 500, 50);
        ...
        passSenha.setBounds(700, 550, 500, 50);
