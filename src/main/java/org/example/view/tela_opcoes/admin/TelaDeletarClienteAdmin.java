...
import org.example.view.tela_opcoes.admin.ouvinte.OuvinteTelaDeletarClienteAdmin;
...
public class TelaDeletarClienteAdmin extends JFrame {
    ...
    public TelaDeletarClienteAdmin(EntityManager em) {
        this.em = em;
        setTitle("TELA DE DELETAR CLIENTE");
        setSize(1280, 780);
        setLayout(null);
        setResizable(false);
    ...
    private void adicionarComponentesDeAtualizacao() {

        OuvinteTelaDeletarClienteAdmin ouvinte = new OuvinteTelaDeletarClienteAdmin(this, em);
        ...
        titulo = new JLabel();
        titulo.setText("DELETAR CLIENTE");
        titulo.setBounds(445, 21, 600, 45);
        ...
        botaoDeletar.setBounds(1000, 655, 200, 50);
