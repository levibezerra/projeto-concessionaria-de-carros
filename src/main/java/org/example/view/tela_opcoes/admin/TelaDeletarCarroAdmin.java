...
import org.example.view.tela_opcoes.admin.ouvinte.OuvinteTelaDeletarCarroAdmin;
...
public class TelaDeletarCarroAdmin extends JFrame {
    ...
    public TelaDeletarCarroAdmin(EntityManager em) {
        this.em = em;
        setTitle("TELA DELETAR CARRO");
        setSize(1280, 780);
        setLayout(null);
        setResizable(false);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        adicionarComponentesDeletarCarro();
        setVisible(true);
    }

    private void adicionarComponentesDeletarCarro() {

        OuvinteTelaDeletarCarroAdmin ouvinte = new OuvinteTelaDeletarCarroAdmin(this, em);
        ...
        botaoDeletar.setBounds(1000, 667, 200, 50);
        botaoDeletar.setFont(new Font("Arial", Font.BOLD, 30));
        botaoDeletar.setForeground(Color.WHITE);
        botaoDeletar.setBackground(Color.BLACK);
        botaoDeletar.setOpaque(true);
